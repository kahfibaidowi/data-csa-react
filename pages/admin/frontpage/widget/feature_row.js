...
class Index extends React.Component{
    ...
    addFeature=(data)=>{
        this.setState({
            feature:this.state.feature.concat([data])
        })
    }
    ...
    toggleConfirmHapus=(idx)=>{
        ...
        .then(result=>{
            if(result.isConfirmed){
                const data=this.state.feature.filter((f, i)=>i!==idx)
                this.setState({
                    feature:data
                })
            }
            ...
            <>
                <Layout>
                    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                        <div>
                            <h4 class="mb-3 mb-md-0">Fitur Baris</h4>
                        </div>
                    </div>
                    <Formik
                        enableReinitialize
                ...
                {formik=>(
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <Modal.Body>
                            ...
                            <div className="mb-2">
                                <label className="my-1 me-2" for="country">Konten</label>
                                <textarea
                                    className="form-control"
                                    name="content"
                                    onChange={formik.handleChange}
