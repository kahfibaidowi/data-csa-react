...
class CurahHujan extends React.Component{
    ...
    request={
        ...
        apiGetsCurahHujan:async(params)=>{
            ...
            return await api(access_token()).get("/curah_hujan/type/provinsi", {
                params:params,
    ...
    //RENDER
    render(){
        const {curah_hujan, edit_curah_hujan, pulau_form}=this.state
            ...
            <>
                <Layout>
                    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                        <div>
                            <h4 class="mb-3 mb-md-0">Data Curah Hujan (Provinsi)</h4>
                        </div>
    ...
    const data_generated=()=>{
        ...
        if(!data.is_loading){
            ...
            if(data.data.length>0){
                new_data=new_data.concat([{index:-1, index_table:data.data.length*5}, {index:-1, index_table:data.length*5+1}])
            }
        }
        return new_data
    }
        ...
        <>
            ...
            <Modal show={full_screen} backdrop="static" fullscreen={true} onHide={()=>setFullScreen(false)} animation={false}>
                ...
                <Modal.Footer className="d-flex justify-content-between align-items-center py-1">
                    <Modal.Title>Data Curah Hujan (Provinsi)</Modal.Title>
