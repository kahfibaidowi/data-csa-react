...
class KabupatenKota extends React.Component{
    state={
        provinsi_form:[],
        region:{
            per_page:15,
    ...
    //RENDER
    render(){
        const {region, tambah_region, edit_region, provinsi_form}=this.state
            ...
            <>
                <Layout>
                    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                        <div>
                            <h4 class="mb-3 mb-md-0">Master Region(Kabupaten/Kota)</h4>
                        </div>
...
const Table=({data, provinsi_form, setPerPage, goToPage, typeFilter, toggleConfirmHapus, toggleModalEdit})=>{
...
const ModalTambah=({data, provinsi_form, toggleModalTambah, addRegion})=>{
                ...
                {formik=>(
                    <form onSubmit={formik.handleSubmit}>
                        <Modal.Header closeButton>
                            <h4 className="modal-title">Tambah Region(Kabupaten/Kota)</h4>
                        </Modal.Header>
                        <Modal.Body>
                            <div className="mb-2">
                                ...
                                <Select
                                    options={provinsi_options()}
                                    value={provinsi_options().find(f=>f.value==formik.values.nested)}
                                    onChange={e=>{
...
const ModalEdit=({data, provinsi_form, toggleModalEdit, updateRegion})=>{
...
export default withAuth(KabupatenKota)